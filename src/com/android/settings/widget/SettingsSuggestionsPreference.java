...
public class SettingsSuggestionsPreference extends Preference {
    ...
    private View createSuggestionView(SuggestionItem suggestion, boolean isLast) {
        ...
        int verticalPadding = context.getResources().getDimensionPixelSize(
                R.dimen.suggestions_item_padding_vertical);
        int horizontalPadding = context.getResources().getDimensionPixelSize(
                R.dimen.suggestions_item_padding_horizontal);
        // Horizontal padding gives the ripple room around the text; a matching negative start
        // margin keeps the first letter aligned with the card title.
