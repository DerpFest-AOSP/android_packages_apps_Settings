...
public class HealthFastChargingPreferenceController extends BasePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        String[] fastChargeEntries = mContext.getStringArray(
        ...
        for (int i = 0; i < supportedFastChargeModes.length; i++) {
            ...
            supportedFastChargeModesEntries[i] = String.valueOf(supportedFastChargeModes[i]);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        mHealthInterface.setFastChargeMode((int) newValue);
        return false;
    }
}
