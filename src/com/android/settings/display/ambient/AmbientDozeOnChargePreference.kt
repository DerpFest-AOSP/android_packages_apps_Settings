...
class AmbientDozeOnChargePreference(context: Context) :
    SwitchPreference(
        key = KEY,
        purpose = R.string.doze_on_charge_purpose,
        title = R.string.doze_on_charge_title,
        summary = R.string.doze_on_charge_summary,
    ),
    ...
    override val availabilityDescription =
        "The device must support ambient display always on."

    override fun getAvailabilityStability() = PreconditionStability.UNSTABLE

    override fun getEnabledDescription(): String =
        "Always-on display must be available and not enabled."
