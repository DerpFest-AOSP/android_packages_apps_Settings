...
class AmbientTiltGesturePreference(context: Context) :
    SwitchPreference(
        key = KEY,
        purpose = R.string.tilt_gesture_purpose,
        title = R.string.tilt_title,
        summary = R.string.tilt_summary,
    ),
    ...
    override val availabilityDescription =
        "The device must have a tilt sensor for ambient display gestures."
